        ...
        <div>
            ...
            <main>
                ...
                <section className="overflow-hidden bg-white dark:bg-transparent">
                    <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-24 flex flex-col items-center justify-center">
                    <motion.div
                        custom={0}
                    ...
                    >
                        ...
                        <div className="relative z-10 mx-auto max-w-2xl text-center">
                            <h1 className="text-balance text-4xl font-semibold md:text-5xl lg:text-6xl">Cursor for videos</h1>
                            <p className="mx-auto my-8 max-w-2xl text-lg">Turn any text into a video with AI.</p>
                            ...
                            <div className="flex gap-2 justify-center">
                                ...
                                <input 
                                    ...
                                    className="px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-800 bg-white/50 dark:bg-gray-900/50"
                                />
                                <Button 
                                    size="lg"
                                    type="submit"
                    ...
                    <div className="mx-auto -mt-16 [mask-image:linear-gradient(to_bottom,black_50%,transparent_100%)]">
                ...
                <section className="bg-background relative z-10 py-16">
                    <div className="m-auto max-w-5xl px-6">
                        <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl p-8 text-center transform hover:scale-[1.01] transition-transform duration-300 cursor-pointer">
                            <h2 className="font-display text-4xl bg-gradient-to-r from-purple-600 to-cyan-500 bg-clip-text text-transparent animate-gradient">
                                Launching Soon
                            </h2>
                            ...
                            <div className="mt-6 flex items-center justify-center gap-4">
                                ...
                                <div className="h-2 w-2 rounded-full bg-blue-500 animate-pulse [animation-delay:200ms]"></div>
                                <div className="h-2 w-2 rounded-full bg-cyan-500 animate-pulse [animation-delay:400ms]"></div>
                            </div>
                        </div>
                    </div>
                </section>
